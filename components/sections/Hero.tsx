    ...
    <section className="relative">
      <div className="bg-clip-hero-container lg:h-[90vh] pb-[150px] lg:pb-0">
        ...
        <div className="container">
          <div className="relative lg:absolute z-30 p-8 lg:p-20 h-full">
        ...
        <div className="lg:hidden absolute w-full  h-[500px] sm:right-0 sm:top-0 top-[-10px] animate-slide-in">
          <Image
            src={heroSVG}
            alt="Hero SVG"
            fill
